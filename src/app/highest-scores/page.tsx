...
export default function HighestScoresPage() {
  ...
  const groupedScores = {
    주요: scores.filter(s => ["국어", "수학"].includes(s.과목명)),
    사탐: scores.filter(s => ["생윤", "윤사", "한지", "사문", "정법", "세지", "동아시아사", "세계사", "경제"].includes(s.과목명)),
    과탐: scores.filter(s => ["물리1", "물리2", "화학1", "화학2", "생명1", "생명2", "지학1", "지학2"].includes(s.과목명)),
    기타: scores.filter(s => !["국어", "수학", "생윤", "윤사", "한지", "사문", "정법", "세지", "동아시아사", "세계사", "경제", "물리1", "물리2", "화학1", "화학2", "생명1", "생명2", "지학1", "지학2"].includes(s.과목명)),
  };
